...
from widgets import (
    ...
    RegistrationWidget, MainProgramWidget, InstructionWidget,
...
class Window(Qt.QMainWindow):
    def __init__(self):
        ...
        self.connection = sqlite3.connect('data_files\data.sqlite')
    ...
    def setMainProgrammWidget(self):
        self.active_window = MainProgramWidget()
        self.setCentralWidget(self.active_window)
    ...
    def setStartBotWidget(self):
        ...
        self.group = self.cursor.execute(f"SELECT group_bots FROM users WHERE login = '{self.active_user}'").fetchone()[
            0]
    ...
    def setManagementBotWidget(self):
        line = self.active_window.bots.currentText()
        ...
        self.bot_thread = threading.Thread(target=self.active_bot.on_bot)
